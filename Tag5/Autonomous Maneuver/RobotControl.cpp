...
RobotControl::RobotControl(): vIst{0.0, 0.0}, vSoll{0.0, 0.0}, iMicros{1500, 1500}, bIsActive{true}, motorL(500,100.0,0.0,0.04), motorR(500,100.0,0.0,0.04), interface(), maneuver(), posEstimation(){
...
void RobotControl::Step(){
  ...
  if(pdInput != nullptr){
    ...
    std::cout << "pdInput is nullptr" << std::endl;
  }
